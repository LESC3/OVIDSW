...
if (ima[indexTag].length>0){$("#ardoraChecks").css("width","875");
...
if ((mp4[indexTag].length>0)||(ogv[indexTag].length>0)){$("#ardoraChecks").css("width","875px");var newDiv=$('<div id="videoForTag"></div>);');
...
if ((ima[indexTag].length==0)&&(mp4[indexTag].length==0)&&(ogv[indexTag].length==0)){$("#ardoraChecks").css("width", "1100px");}
